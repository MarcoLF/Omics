...
TFBs.analysis = function(input,data,pwm,score){
  ...
  for(i in 1:length(data)) {
    ...
    write.table(final.df2, paste0(input, data[i], "TFB_analysis_", score, ".txt"),
                sep = "\t", quote = F)
    ...
    ggsave(paste0(input, data[i], "_TFB_analysis.pdf"), plot = g,
          device = "pdf");
...
TFBs.analysis(input, data =name, pwm, score = "95%")
```